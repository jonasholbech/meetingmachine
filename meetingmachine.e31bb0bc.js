...
var _default = (0, _xstate.Machine)({
  ...
  states: {
    ...
    dont_meet: {
      entry: (0, _xstate.assign)({
        header: "Don't Meet",
        description: "If the item isn't business-critical, consider dealing with this topic another way"
      }),
      type: "final"
    },
    ...
    use_other_collaboration_options: {
      entry: (0, _xstate.assign)({
        ...
        description: "Collaborate on a task in your PM tool. Or run a survey, or do a quick group chat online"
      }),
      type: "final"
    },
    ...
    is_there_still_value: {
      entry: (0, _xstate.assign)({
        ...
        description: "Can the group still add significant value by meeting? If not, stop here and don't meet"
      }),
      on: {
    ...
    add_pre_work: {
      entry: (0, _xstate.assign)({
        header: "Add pre-work",
        description: "Do as much as possible before the meeting to cut down meeting time."
      }),
      on: {
  ...
  actions: {
    is_it_an_important_topic_entry: (0, _xstate.assign)({
...
},{"xstate":"node_modules/xstate/es/index.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _xstate = require("xstate");

var _machineConfig = _interopRequireDefault(require("./machineConfig"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var service = (0, _xstate.interpret)(_machineConfig.default).start();
var state = service.send("START");
...
function setup() {
  ...
  copy.querySelector(".buttons").addEventListener("click", function (e) {
...
},{"xstate":"node_modules/xstate/es/index.js","./machineConfig":"machineConfig.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/meetingmachine.e31bb0bc.js.map